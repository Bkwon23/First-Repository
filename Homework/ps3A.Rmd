...
> ANSWER: I am still a bit confused on the function of ObserveEvent; when do we use this function and what is its significance to Shiny?  I am also wondering why we would need to use isolate() as a function if we can just manually choose not to change a specific aspect of a data graphic?

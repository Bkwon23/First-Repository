...
> ANSWER:
On Tuesday, my group and I are planning to use today to prepare our individual datasets that we were supposed to find (i.e. a solid vaccination dataset for me, infant dataset for Ayodele, and API setups for Clara) so that we can be fully prepared to tackle tidying/wrangling our data during class tomorrow.
...
my_path <- "~/Spring 2021/Data Science - STAT 231"

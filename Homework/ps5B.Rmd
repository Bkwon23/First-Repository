...
> ANSWER:   There seems to be a significantly high concentration of U.S. Supreme Court Justices who have served on the court for a tenure of fewer than 20 years.  This is when compared to Justices who have served for at least 25 years.  This could be because you need to have a considerable amount of legal experience before assuming a seat, and as a result, most appointed justices are elderly.  Therefore, despite having their seat "for life," many may reach a retirement age relatively early in their career serving on the Supreme Court.
...
ggplot(data = justices2, aes(x = tenure_length)) + 
  geom_density(adjust = 1/5, fill = "seagreen", color = "midnightblue") + 

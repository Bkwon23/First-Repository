...
path_out <- "C:/Users/kcorreia/Dropbox (Amherst College)/Teaching/Spring 2021/Stat231/R Labs/data"
write_csv(DickinsonPoems_ex3, file = paste0(path_out,"/DickinsonPoems.csv"))

...
> RESPONSE: The coverage dataset spans over the years of 2031-2016, and the spending dataset covers the years from 1991 to 2014.  As a result, because the only overlap is from 2013 to 2014, we use the overlap to the best of our ability to make comparisons.
...
> RESPONSE: The variables needed for the x-axis will be "2013 Total Health Spending" and "2014_Total Health Spending".  The variables needed for the y-axis will be "2013_Employer" and "2014_Employer".  The variable "Location" will be used to differentiate the points.  Each observation will represent a specific state's healthcare spending and employer coverage for a specific year.
